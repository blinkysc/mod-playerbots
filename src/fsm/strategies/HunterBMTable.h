...
#ifndef _PLAYERBOT_HUNTERBMTABLE_H
#define _PLAYERBOT_HUNTERBMTABLE_H
...
/**
 * Beast Mastery Hunter Action Table (DPS)
 *
 * BM Hunters focus on pet damage and utility.
 * Key abilities: Bestial Wrath, Kill Command, Intimidation, Steady Shot
 */

namespace HunterBMStrategy
{
    constexpr uint16_t STRATEGY_ID = 700;
    ...
    static const ActionDefinition rules[] = {
        ...
        // Pet management - Call Pet (out of combat or dead pet)
        {
        ...
        // Aspect - Dragonhawk (preferred for BM)
        {
        ...
        // BM Cooldown - Bestial Wrath
        {
            .id = HunterActions::BestialWrath,
            .name = "bestial wrath",
            .condition = ConditionBuilder()
                .requirePrimary(PrimaryState::InCombat | PrimaryState::HasTarget | PrimaryState::HasPet)
                .forbidPrimary(PrimaryState::Dead)
        ...
        // Kill Command (core BM ability)
        {
            .id = HunterActions::KillCommand,
            .name = "kill command",
            .condition = ConditionBuilder()
                .requirePrimary(PrimaryState::InCombat | PrimaryState::HasTarget | PrimaryState::HasPet)
                .forbidPrimary(PrimaryState::Dead)
        ...
        // Intimidation (BM stun)
        {
            .id = HunterActions::Intimidation,
            .name = "intimidation",
            .condition = ConditionBuilder()
                .requirePrimary(PrimaryState::InCombat | PrimaryState::HasTarget | PrimaryState::HasPet)
                .forbidPrimary(PrimaryState::Dead)
    ...
    static const ActionTable table = {rules, RULE_COUNT, STRATEGY_ID, "beast mastery hunter"};
}
