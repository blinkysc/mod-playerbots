...
#ifndef _PLAYERBOT_HUNTERSURVIVALTABLE_H
#define _PLAYERBOT_HUNTERSURVIVALTABLE_H
...
/**
 * Survival Hunter Action Table (DPS)
 *
 * Survival Hunters focus on traps, DoTs, and explosive damage.
 * Key abilities: Explosive Shot, Black Arrow, Lock and Load procs
 */

namespace HunterSurvivalStrategy
{
    constexpr uint16_t STRATEGY_ID = 702;
    ...
    static const ActionDefinition rules[] = {
        ...
        // Interrupt - Scatter Shot (Survival uses this)
        {
            .id = HunterActions::ScatterShot,
            .name = "scatter shot",
            .condition = ConditionBuilder()
            ...
            .cooldownMs = 30000,
            .alternatives = {HunterActions::WyvernSting, INVALID_ACTION, INVALID_ACTION, INVALID_ACTION}
        },
        ...
        // Explosive Shot (Survival signature)
        {
            .id = HunterActions::ExplosiveShot,
            .name = "explosive shot",
            .condition = ConditionBuilder()
                .requirePrimary(PrimaryState::InCombat | PrimaryState::HasTarget)
                .forbidPrimary(PrimaryState::Dead)
        ...
        // Black Arrow (Survival DoT)
        {
            .id = HunterActions::BlackArrow,
            .name = "black arrow",
            .condition = ConditionBuilder()
                .requirePrimary(PrimaryState::InCombat | PrimaryState::HasTarget)
                .forbidPrimary(PrimaryState::Dead)
        ...
        // Explosive Trap (AoE)
        {
            .id = HunterActions::ExplosiveTrap,
            .name = "explosive trap",
            .condition = ConditionBuilder()
                .requirePrimary(PrimaryState::InCombat | PrimaryState::HasTarget)
                .forbidPrimary(PrimaryState::Dead)
        ...
        // Counterattack (Survival melee proc)
        {
            .id = HunterActions::CounterAttack,
            .name = "counterattack",
            .condition = ConditionBuilder()
                .requirePrimary(PrimaryState::InCombat | PrimaryState::HasTarget)
                .forbidPrimary(PrimaryState::Dead)
    ...
    static const ActionTable table = {rules, RULE_COUNT, STRATEGY_ID, "survival hunter"};
}
